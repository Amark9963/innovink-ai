...
const toolRegistry = {
  ...
  draft_landing_page: {
    toolName: "draft_landing_page",
    category: "drafting",
    description: "Draft a governed landing page artifact from the current brief and plan context.",
  ...
  draft_registration_form: {
    toolName: "draft_registration_form",
    category: "drafting",
    description: "Draft a governed registration form artifact from the current brief and plan context.",
    executorType: "planner_internal",
    riskLevel: "low",
    approvalRequired: false,
    idempotent: true,
  ...
  draft_submission_form: {
    toolName: "draft_submission_form",
    category: "drafting",
    description: "Draft a governed submission form artifact from the current brief and plan context.",
    executorType: "planner_internal",
    riskLevel: "low",
    approvalRequired: false,
    idempotent: true,
  ...
  draft_judging_setup: {
    toolName: "draft_judging_setup",
    category: "drafting",
    description: "Draft a governed judging setup artifact from the current brief and plan context.",
    executorType: "planner_internal",
    riskLevel: "low",
    approvalRequired: false,
    idempotent: true,
