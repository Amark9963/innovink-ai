    ...
    <OperatorShell
      ...
      headerActions={
        <button
          type="button"
          disabled
          className="rounded-md border border-white/10 px-3 py-1.5 text-[11.5px] font-medium text-[#9baabf] transition disabled:opacity-100"
        >
          Browse templates
        </button>
      }
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {data.brief ? (
              ...
              <div className="flex h-full flex-col items-center justify-center rounded-xl border border-dashed border-white/10 bg-[#162034] px-8 py-10 text-center">
                ...
                <div className="mt-5 text-[11.5px] text-[#5e7088]">Start by describing your program →</div>
              </div>
            )}
          </div>
        </>
      ...
      <div className="flex h-[calc(100vh-56px)] flex-col bg-[#07101f]">
        <div className="flex shrink-0 items-center justify-between border-b border-white/7 bg-[#111e30] px-5 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[13px] font-medium text-[#eae5dc]">Innova — AI Program Architect</div>
          ...
          <button
            type="button"
            className="rounded-md border border-white/10 px-3 py-1.5 text-[11.5px] text-[#9baabf] transition hover:bg-white/[0.04] hover:text-[#eae5dc]"
          >
            History
          </button>
        </div>
          ...
          <div className="mx-auto mb-7 max-w-[580px]">
            ...
            <div className="grid gap-2 md:grid-cols-2">
              {templates.map((template) => (
                ...
                >
                  <div className={`mb-[10px] flex h-8 w-8 items-center justify-center rounded-md text-[11px] font-semibold ${template.iconClass}`}>
                  ...
                  <div className="mt-[10px] flex items-center justify-between">
                    ...
                    <span className="text-[11px] text-[#5e7088] transition group-hover:text-[#ccaa4a]">
                      Use →
                    </span>
                  </div>
                </div>
